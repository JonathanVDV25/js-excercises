...
const Navbar = () => {
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Fiche 08</a>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item"> 
                <a class="nav-link" href="#" data-uri="/dactylo" id="dactylo">Dactylographier</a>
              </li> 
              <li class="nav-item"> 
                <a class="nav-link" href="#" data-uri="/creer" id="creer">Créer un texte</a>
              </li>                      
            </ul>
          </div>
        </div>
